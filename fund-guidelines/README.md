...
We are interested to find out who you are most concerned with helping. The options we present will be many but not exhaustive. Resist the temptation to select all that might apply. We are most interested in your top priorities, the ones you know apply.

What about our priorities? We are most interested in efforts that lead to good policy in places where positive effects will be felt by more than the people in the country where the policy was set. The global affect EU's General Data Protection Regulation \(GDPR\) is having is an example. A good application does not have to be directly engaging in policy & advocacy as a type of work but it does need to clearly show how the work's outcomes will or could lead to policy change. For example, the countless research and technology projects demonstrating the myriad misuse of data justifying the need for GDPR would have been in scope \(and still are for enforcement or to point out limitations\). 
